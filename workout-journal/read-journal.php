...
<body>
    ...
    <div class="main">
        ...
        <?php
            ...
            $query = "SELECT DISTINCT date FROM tbl_activities WHERE user_id = '$userID'";
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                // Format date as full month name, day, and year
                $formattedDate = date('F j, Y', $timestamp);
                
                // Use the formatted date as the display text for the option
                $options .= "<option value='" . $row['date'] . "'>" . $formattedDate . "</option>";
            }
        ?>
                ...
                <?php
                    ...
                    if (isset($_POST['search'])) {
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            $query = "SELECT * FROM tbl_activities WHERE user_id = $userID AND date = '$searchDate'";
                            $result = mysqli_query($conn, $query);
